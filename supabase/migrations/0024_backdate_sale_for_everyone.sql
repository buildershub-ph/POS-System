...
-- ---------------------------------------------------------------------------
-- Backdating a sale was restricted to owner/manager in 0022. Opening it up to
-- anyone who can process a sale at all (sales_employee, cashier included) --
-- identical to 0023's create_sale, minus the can_approve gate on saleDate.
-- ---------------------------------------------------------------------------
...
begin
  ...
  -- Backdating is open to anyone who can process a sale at all -- actor_role
  -- was already checked above, so no further role gate here.
